...
const App = () => {
  ...
  return (
    <div
      className={`bg-white-800 text-gray-100 scrollbar-hide flex flex-col  text-2xl`}
    >
      <div
        className={`bg-slate-800 ${
          matchData?.length < 2 || loading ? "h-screen" : " h-[ 100 %]"
        } scrollbar-hide`}
      >
        <p className="justify-center items-center text-xl font-semibold ml-5 mt-2">
          Schedule
        </p>
        ...
        <div className="mt-5 flex w-[100%] border-1 overscroll-none">
          <div
            ...
            className={`w-[33%] flex flex-col items-center border-b-4 pb-2 ${
              activeTab === UPCOMING ? "border-cyan-700 " : " border-slate-600"
            }`}
          >
            <p
              className={`justify-center items-center text-base ${
                activeTab === UPCOMING ? "text-cyan-600 " : "  text-gray-500 "
              }`}
            >
              Upcoming
            </p>
          ...
          <div
            ...
            className={`w-[33%] flex flex-col items-center border-b-4 pb-2 ${
              activeTab === LIVE ? "border-cyan-700" : "border-slate-600"
            }`}
          >
            <p
              className={`justify-center items-center text-base ${
                activeTab === LIVE ? "text-cyan-600 " : "  text-gray-500 "
              }`}
            >
              Live
            </p>
          ...
          <div
            ...
            className={`w-[33%] flex flex-col items-center border-b-4 pb-2 ${
              activeTab === RESULTS ? "border-cyan-700" : "border-slate-600"
            }`}
          >
            <p
              className={`justify-center items-center text-base ${
                activeTab === RESULTS ? "text-cyan-600 " : "  text-gray-500 "
              }`}
            >
              Results
            </p>
        ...
        <div className="mx-4 mt-2 mb-4 flex bg-gray-700 p-0.5 rounded-full">
          <div
            ...
            className={`w-[33%] flex flex-col justify-center items-center py-3  ${
              activeType === ALL
                ? "border-2 border-green-700 rounded-full bg-slate-800"
                : null
            }`}
          >
            <p className={`justify-center items-center text-xs font-medium `}>
              ALL
            </p>
          </div>
          ...
          <div
            ...
            className={`w-[33%] flex flex-col items-center py-3 ${
          ...
          <div
            onClick={() => setActiveType(DOMESTRIC)}
            className={`w-[33%] flex flex-col items-center py-3 ${
              activeType === DOMESTRIC
                ? "border-2 border-green-700 rounded-full bg-slate-800"
                : null
            }`}
          >
        ...
        <div className=" mb-10 ">
          {loading ? (
            ...
            matchData.map((series) => (
              <>
                <div
                  className={`mt-6 mb-2 mx-2 bg-gray-700 flex items-center justify-between rounded-2xl p-3 w-'100% `}
                >
                  <div className="flex items-center ">
                    <div className="h-7 w-11 bg-red-500 rounded-md flex justify-center items-center">
                      <p className="text-sm font-medium">
                        {series.league.slice(0, 3).toUpperCase()}
                      </p>
                    </div>
                          ...
                          <div className="">
                            <div className="flex">
                              ...
                              <div className="py-1 px-2 flex items-center border-2	border-cyan-500 ml-3 rounded-full ">
                                ...
                                <p className="text-cyan-500 text-sm pl-1.5">
            ...
            <div className="flex justify-center items-center h-[100%]">
              <p className="text-gray-50">No Records Found</p>
            </div>
          )}
        </div>
      </div>
